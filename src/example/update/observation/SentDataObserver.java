...
public class SentDataObserver implements Control {
    ...
    public boolean execute() {
        ...
        log.append("Node;totalOut;totalIn;dataOut;dataIn;dataOut(Byte);dataIn(Byte)" + System.lineSeparator());

        for (int i = 0; i < Network.size(); i++) {

            NetworkAgent proto = (NetworkAgent) Network.get(i).getProtocol(pid);
            log.append(Network.get(i).getID() +  ";" + proto.counter.getOutgoingTotal() + ";" + proto.counter.getIngoingTotal() + ";" + proto.counter.getOutgoingData() + ";" + proto.counter.getIngoingData() + ";" + proto.counter.getDataOut() + ";" + proto.counter.getDataIn()).append(System.lineSeparator());
        }
